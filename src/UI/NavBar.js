    ...
    return (
        <>
            <div className='navbar flex flex-w jus-c' >
                <a href="#" className='mobileIcon'><svg width="6" height="14" viewBox="0 0 6 14" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <ul className='flex jus-se aln-c w-100'>
                    ...
                    <li>
                        <a href="#" className='navlink'>Product <svg xmlns="http://www.w3.org/2000/svg" width="12" height="6" viewBox="0 0 19 9" fill="currentColor">
